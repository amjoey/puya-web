...
// Modal primitive — see UI_UX_SPEC.md > UX Rules ("Confirmation Dialogs").
// Also the base for admin slip-preview and approve/reject modals.
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-md opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none"
          >
